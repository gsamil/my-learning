...
- [HuggingFace DeepRL (and others)](https://huggingface.co/learn/deep-rl-course/unit0/introduction)

## Coding

- [V0](https://v0.dev) : Frontend
- [Replit](https://replit.com) : For deployment

## Updates

- [HuggingFace Posts](https://huggingface.co/posts)
